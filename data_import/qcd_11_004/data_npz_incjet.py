...
def main(args):
	...
	#intervention to use new npcorr factors
	#intervention to use new npcorr factors
	#npcordata = numpy.genfromtxt('npcorsamantha.txt',names = True)
	#print npz_storage.keys()
	#print npcordata['npxps']
	#npz_storage['npcor'] = npcordata['npxps']
